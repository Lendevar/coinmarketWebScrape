...
def collectNowData():
    ...
    url ='https://coinmarketcap.com/watchlist/61937030940b65744f58b6ca'
    driverNow.get(url)
    ...
    now = datetime.now()
    dt_string = now.strftime("watch-%d-%m-%y-%H")
...
pastFile = open('watch-18-11-21-18.txt', "r", encoding='utf-8')
...
now = datetime.now()
dt_string = now.strftime("watchDifference-%d-%m-%y-%H")
